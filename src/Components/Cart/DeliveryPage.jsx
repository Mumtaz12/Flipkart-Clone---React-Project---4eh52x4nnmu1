                    ...
                    <Box w="100%" h="70vh" bg="#f5faff" display="block" shadow="md" pl="10" pt="5">
                        ...
                        <Box display="flex" justifyContent="space-evenly" mt="8" w="80%">
                            <Flex flexDirection={["column", "row"]} w="100%">
                                ...
                                <Input
                                    ...
                                    w={["30%", "20%"]}
                                    className={!CountryCode.match(/^\d{3}$/) ? "invalid-input" : "valid-input"} // You can apply a style class here
                                    p="6"
                                />
                                <Input
                                    value={Number}
                                    ...
                                    bg="white"
                                    p="6"
                                    focusBorderColor={Number.match(/^\d{1,10}$/) ? 'lime' : 'red.300'}
                        ...
                        <Box display="flex" justifyContent="space-evenly" mt="4" w="80%">
                            <Input
                                ...
                                bg="white"
                                p="6"
                                focusBorderColor={Email.match(/^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/)  ? 'lime' : 'red.300'}
                            />
                            <Input
                                value={Pincode}
                                onChange={handleInputChange}
                                ...
                                maxLength={6}
                                w={["100%", "45%"]}
                                className={!Pincode.match(/^\d{1,6}$/)  ? "invalid-input" : "valid-input"}
                                border="2px solid "
                                bg="white"
                                p="6"
                            />
...
//
//
// import { Box, Button, Flex, Text, Textarea, Input, Spacer } from "@chakra-ui/react";
// import React, { useContext, useState } from "react";
// import { CartContext } from "../Context/CartContext";
// import { Navigate } from "react-router-dom";
// // import { MdSecurity } from "react-icons/md";
...
//                                 maxLength={6}
//                                 w={["100%", "45%"]}
//                                 className={!Pincode.match(/^\d{6}$/) ? "invalid-input" : "valid-input"}
//                                 border="2px solid "
//                                 bg="white"
//                                 p="6"
//                             />
...
//                         </Text>
//                     </Box>
//                     <Box display="flex" justifyContent="center" alignItems="center" bg="white" mt="3" p="2">
//                         <Button
//                             colorScheme="blue"
//                             size="md"
//                             width="90%"
